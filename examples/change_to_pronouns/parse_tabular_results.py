...
for entry in data:
    tmp = []
    # tmp.append(entry["orig_sentence0"])
    # tmp.append(entry["orig_sentence1"])
    # tmp.append(entry["orig_sentence2"])
    # tmp.append(entry["orig_sentence3"])
    # tmp.append(entry["orig_sentence4"])
    # tmp.append(entry["orig_sentence5"])
    # tmp.append(entry["orig_sentence6"])
    # tmp.append(entry["orig_sentence7"])
    # tmp.append(entry["orig_sentence8"])
    # tmp.append(entry["orig_sentence9"])
